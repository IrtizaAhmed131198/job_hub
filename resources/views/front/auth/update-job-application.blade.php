                    ...
                    <section class="mb-50">
                        <div class="row">
                            <div class="col-xl-9 col-md-12 mx-auto">
                                ...
                                @endif
                                <form class="contact-form-style mt-80" action="{{ route('jobs.apply.edit', $job->id) }}" method="POST" enctype="multipart/form-data" id="jobApplicationForm">
                                    @csrf
                                    ...
                                    <div class="row wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="input-style mb-20">
                                                <input type="number" id="years_of_experience" name="years_of_experience" value="{{ $data->years_of_experience }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <label for="education_level">Education Level</label>
                                            <div class="input-style mb-20">
                                                <input type="text" class="form-control" id="education_level" name="education_level" value="{{ $data->education_level }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <label for="skype_id">Skype ID</label>
                                            <div class="input-style mb-20">
                                                <input type="text" class="form-control" id="skype_id" name="skype_id" value="{{ $data->skype_id }}" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            ...
                                            <div class="input-style mb-20">
                                                <select class="form-control" id="contact_for_other_roles" name="contact_for_other_roles" required>
                                                    <option value="1" {{ $data->contact_for_other_roles == 1 ? 'selected' : '' }}>Yes</option>
                                                    <option value="0" {{ $data->contact_for_other_roles == 0 ? 'selected' : '' }}>No</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-12 col-md-12">
                                            <label for="languages">Languages Spoken</label>
                                            <div class="input-style mb-20" id="languagesWrapper">
                                                @foreach ($data->languages as $language)
                                                    <div class="input-group mb-2">
                                                        <input type="text" class="form-control" name="languages[]" value="{{ $language }}" required>
                                        ...
                                        <div class="col-lg-6 col-md-6">
                                            ...
                                            <div class="input-style mb-20">
                                                <input type="file" class="form-control-file" id="cv" name="cv" {{ $data->cv_path ? '' : 'required' }}>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6">
                                            @if ($data->cv_path)
                                                <input type="hidden" name="hidden_cv" value="{{ $data->cv_path }}">
                                                <a href="{{ $data->cv_path_link }}" class="btn btn-primary" target="_blank" style=" margin-top: 28px; ">View CV</a>
                                            @endif
                                        </div>
