                    ...
                    <div class="single-apply-jobs">
                        <div class="row align-items-center">
                            <div class="col-md-5">
                                @if (Auth::check())
                                    @if (!empty($job_app))
                                        <a href="#" class="btn btn-default mr-15">Applied</a>
                                    @else
                                        <a href="{{ route('jobApplication', ['id' => $data->id]) }}" class="btn btn-default mr-15">Apply now</a>
                                    @endif
                                @else
                                    <a href="#" class="btn btn-default mr-15 disabled" aria-disabled="true" tabindex="-1">Apply now</a>
                                @endif

                            </div>
                            <div class="col-md-7 text-lg-end social-share">
                                <a href="#" class="btn btn-border btn-sm mr-10"><img alt="jobhub" src="{{ url('public/assets/imgs/theme/icons/share-fb.svg') }}" /> Share</a>
                                <a href="#" class="btn btn-border btn-sm mr-10"><img alt="jobhub" src="{{ url('public/assets/imgs/theme/icons/share-tw.svg') }}" /> Tweet</a>
                                <a href="#" class="btn btn-border btn-sm"><img alt="jobhub" src="{{ url('public/assets/imgs/theme/icons/share-pinterest.svg') }}" /> Pin</a>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-job hover-up wow animate__animated animate__fadeInUp">
                                    <div class="card-job-top">
                                        ...
                                        <div class="card-job-top--info">
                                            <h6 class="card-job-top--info-heading"><a href="{{ route('job.inner', ['id' => $val->id]) }}">{{ $val->title }}</a></h6>
                                            <div class="row">
                                                <div class="col-lg-7">
                                                    <a href="employers-grid.html"><span class="card-job-top--company">{{ $val->company }}</span></a>
                                                    ...
                                                    <span class="card-job-top--type-job text-sm"><i class="fi-rr-briefcase"></i>
                                                        {{ $val->job_type }}</span>
                                                    <span class="card-job-top--post-time text-sm"><i class="fi-rr-clock"></i> {{ $val->created_at_ago }}</span>
                                                </div>
                                    ...
                                    <div class="card-job-bottom mt-25">
                                        <div class="row">
                                            <div class="col-lg-9 col-sm-8 col-12">
                                                ...
                                                @endif
                                                <a href="#" class="btn btn-small background-6 disc-btn">{{ $val->job_type }}</a>
                                            </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 col-12 pl-40 pl-lg-15 mt-lg-30">
                    <div class="sidebar-shadow">
                        ...
                        <div class="text-start mt-20">
                            @if (Auth::check())
                                <a href="{{ route('jobApplication', ['id' => $data->id]) }}" class="btn btn-default mr-10">Apply now</a>
                            @else
                                <a href="#" class="btn btn-default mr-10 disabled" aria-disabled="true" tabindex="-1">Apply now</a>
                            @endif
                        </div>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="sidebar-text-info">
                                        ...
                                        <strong class="small-heading">{{ $data->job_type }} / {{ $data->job_type2 }}</strong>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="sidebar-text-info">
                                        ...
                                        <strong class="small-heading">{{ $data->experience_level }} / {{ $data->experience_level2 }}</strong>
                                    </div>
                                </li>
                                <li>
