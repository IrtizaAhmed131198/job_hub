    ...
    <table width="600" cellspacing="0" cellpadding="0" border="0" align="center" style="background-color: #ffffff; margin: 20px auto; padding: 20px; box-shadow: 0 0 10px rgba(0,0,0,0.1);">
        ...
        <tr>
            <td align="center" style="text-align: center;">
                <h1 style="margin-top: 20px;">Welcome to All Shifts!</h1>
            </td>
        </tr>
        <tr>
            <td style="text-align: left; padding: 20px;">
                <h2>Dear {{ $userName }},</h2>
                <p>You have successfully signed up to our website. We're excited to have you as a member of our community.</p>
                <p>Your registration is complete, and your account is ready.</p>
            </td>
        </tr>
        <tr>
